...
export default function Layout() {
  ...
  const navItems = [
    ...
    { path: '/grooming', icon: 'M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z', label: 'Grooming', roles: ['admin', 'administrador', 'empleado', 'groomer'] },
    ...
    { path: '/mis-citas', icon: 'M16 7l-4-4-4 4m8 0l-4 4-4-4', label: 'Mis citas', roles: ['cliente'] },
    ...
    { path: '/reportes', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z', label: 'Reportes', roles: ['admin', 'administrador', 'empleado', 'groomer', 'veterinario', 'cliente'] },
