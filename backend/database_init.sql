...
-- Crear empleado de prueba (password: Empleado@123!)
INSERT INTO USUARIO (nombre, apellido, email, password_hash, rol, email_verificado, activo)
VALUES (
    'Empleado',
    'Demo',
    'empleado@demo.com',
    '$2a$10$TBGe0LXb.bx9lkdHaGX4t.eahCqc6S8oxawMQA5THCpXzg0c.jb2K',
    'empleado',
    TRUE,
    TRUE
)
ON DUPLICATE KEY UPDATE locked_until = NULL, login_attempts = 0, email_verificado = TRUE, activo = TRUE;
